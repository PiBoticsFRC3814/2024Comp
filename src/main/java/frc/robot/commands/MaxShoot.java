...
public class MaxShoot extends Command {
  ...
  public MaxShoot(FlywheelShooter shooter, Intake intake, RobotStates robotState) {
  ...
  public void execute() {
    ...
    if((shooter.speed.getVelocity() >= 4500) && (!robotState.autonomous || robotState.inSpeaker)){
